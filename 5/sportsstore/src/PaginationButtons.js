...
export class PaginationButtons extends Component {
    getPageNumbers = () => {
        if (this.props.pageCount < 4) {
            //If the number of pages is less than 4, all numbers should be displayed
            ...
            // If the current page is near the end display last 5
            return [...Array(5).keys()]
                .reverse()
                .map((v) => this.props.pageCount - v);
        } else {
            //Lots of pages and in between page number
            return [
